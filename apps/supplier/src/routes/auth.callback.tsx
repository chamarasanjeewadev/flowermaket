 ...
 * bounces to the intended destination. New suppliers land on "/", and the
 * root beforeLoad forwards them to /onboarding when they have no shop yet.
 * Errors bounce to /login where the `error` search param is shown.
 */
